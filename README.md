...
[![Version 1.7.1](https://img.shields.io/badge/version-1.7.1-purple.svg)](https://github.com/ralforion/orionbelt-ontology-builder/releases)
...
Then open http://localhost:8501. Use `:1.7.1` to pin a specific version instead of `latest`.
